...
( function () {
	...
	function goNext() {
		...
		const selected = body.querySelector( 'input[name="fyt-q-' + q.id + '"]:checked' );
	...
	function renderQuestion( index ) {
		...
		const saved   = answers[ q.id ] ? answers[ q.id ].answerId : null;
		...
		// Question HTML
		let answersHtml = '<ul class="fyt-answers" role="radiogroup" aria-labelledby="fyt-question-text">';
		q.answers.forEach( function ( a ) {
			const checked = saved === a.id ? ' checked' : '';
			answersHtml += '<li class="fyt-answer">' +
				'<input type="radio" id="fyt-a-' + esc( a.id ) + '" name="fyt-q-' + esc( q.id ) + '" value="' + esc( a.id ) + '" data-tags="' + esc( JSON.stringify( a.tags ) ) + '"' + checked + '>' +
				'<label class="fyt-answer__label" for="fyt-a-' + esc( a.id ) + '">' +
		...
		// Enable/disable next based on saved answer
